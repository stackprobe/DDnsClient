...
namespace Charlotte.Tools
{
	public class StringTools
	{
		...
		public static readonly string HAN_KATAKANA = ENCODING_SJIS.GetString(ArrayTools.ByteSq(0xa1, 0xdf));
		...
		public static string ConvCRLF(string str, string lineNew = "\n")
		{
			str = str.Replace("\r", "");
			str = str.Replace("\n", lineNew);
			return str;
		...
		public static int IndexOfIgnoreCase(string src, string ptn)
		{
			return src.ToLower().IndexOf(ptn.ToLower());
		}
	}
}
