...
namespace Charlotte.Tools
{
	public static class JString
	{
		...
		public static string ToJString(string str, bool okJpn, bool okRet, bool okTab, bool okSpc, bool ok前後の空白_trimしない, int minlen = MINLEN, int maxlen = MAXLEN, char defchr = DEFCHR)
		{
			if (str == null)
				str = "";
